...
<form method="POST" action="<?php echo e(route("technician.service.checklist.submit", $service)); ?>" data-stage="points">
    <?php echo csrf_field(); ?>
    ...
    <div class="checkbox-group">
        <div class="checkbox-item">
            <input type="checkbox" name="installed_points_check" value="1" 
                   <?php echo e(($service->checklist_data["points"]["installed_points_check"] ?? false) ? "checked" : ""); ?>
        ...
        <div class="checkbox-item">
            <input type="checkbox" name="existing_points_check" value="1" 
                   <?php echo e(($service->checklist_data["points"]["existing_points_check"] ?? false) ? "checked" : ""); ?>
        ...
        <div class="checkbox-item">
            <input type="checkbox" name="spare_points_check" value="1" 
                   <?php echo e(($service->checklist_data["points"]["spare_points_check"] ?? false) ? "checked" : ""); ?>
        ...
        <div class="checkbox-item">
            <input type="checkbox" name="bait_weight_check" value="1" 
                   <?php echo e(($service->checklist_data["points"]["bait_weight_check"] ?? false) ? "checked" : ""); ?>
        ...
        <div class="checkbox-item">
            <input type="checkbox" name="physical_installed_check" value="1" 
                   <?php echo e(($service->checklist_data["points"]["physical_installed_check"] ?? false) ? "checked" : ""); ?>
        ...
        <div class="checkbox-item">
            <input type="checkbox" name="physical_existing_check" value="1" 
                   <?php echo e(($service->checklist_data["points"]["physical_existing_check"] ?? false) ? "checked" : ""); ?>
        ...
        <div class="checkbox-item">
            <input type="checkbox" name="physical_spare_check" value="1" 
                   <?php echo e(($service->checklist_data["points"]["physical_spare_check"] ?? false) ? "checked" : ""); ?>
