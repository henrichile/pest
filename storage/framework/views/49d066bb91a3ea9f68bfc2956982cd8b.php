        ...
        <div class="p-6">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="font-medium text-gray-900"><?php echo e($service->client->name ?? "N/A"); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1">Teléfono</p>
                        <p class="font-medium text-gray-900"><?php echo e($service->client->phone ?? "N/A"); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1">Email</p>
                        <p class="font-medium text-gray-900"><?php echo e($service->client->email ?? "N/A"); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1">Dirección</p>
                        <p class="font-medium text-gray-900"><?php echo e($service->address ?? "N/A"); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-blue-700">El servicio está programado para <?php echo e($service->scheduled_date->format("d/m/Y H:i")); ?></p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <a href="<?php echo e(route("technician.service.start", $service)); ?>">
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-yellow-700">Iniciado el <?php echo e($service->started_at->format("d/m/Y H:i")); ?></p>
                        </div>
                    </div>
                    <div class="mt-4 flex space-x-3">
                        <a href="<?php echo e(route("technician.service.checklist", $service)); ?>" 
                ...
                <div class="mt-6 bg-green-50 border border-green-200 rounded-lg p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-green-700">Completado el <?php echo e($service->checklist_completed_at ? $service->checklist_completed_at->format("d/m/Y H:i") : "Fecha no disponible"); ?></p>
                        </div>
                    </div>
                    <div class="flex space-x-3">
                        ...
                        <a href="<?php echo e(route("technician.service.pdf", $service)); ?>" class="inline">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium"><?php echo e($service->service_type ?? "Sanitización"); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Prioridad:</span>
                            <span class="font-medium"><?php echo e(ucfirst($service->priority ?? "Media")); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Programado:</span>
                            <span class="font-medium"><?php echo e($service->scheduled_date->format("d/m/Y H:i")); ?></span>
                        </div>
                        <?php if($service->started_at): ?>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Iniciado:</span>
                            <span class="font-medium"><?php echo e($service->started_at->format("d/m/Y H:i")); ?></span>
                        </div>
                        <?php endif; ?>
                        <?php if($service->completed_at): ?>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Completado:</span>
                            <span class="font-medium"><?php echo e($service->checklist_completed_at ? $service->checklist_completed_at->format("d/m/Y H:i") : "Fecha no disponible"); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium"><?php echo e($service->observations->count()); ?></span>
                        </div>
                        <?php if($service->started_at && $service->completed_at): ?>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Duración:</span>
                            <span class="font-medium"><?php echo e($service->started_at->diffInMinutes($service->completed_at)); ?> min</span>
                        </div>
                        <?php endif; ?>
                        <div class="flex justify-between">
            ...
            <div class="mt-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-700"><?php echo e($service->description); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t">
            <div class="flex justify-between items-center">
                ...
                <div class="text-sm text-gray-500">
                    Última actualización: <?php echo e($service->updated_at->format("d/m/Y H:i")); ?>
