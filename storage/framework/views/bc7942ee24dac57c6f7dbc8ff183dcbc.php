<?php $__env->startSection("title", "Servicios - Pest Controller SAT"); ?>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-500"><?php echo e($service->address); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/pest-controller/resources/views/services/index.blade.php ENDPATH**/ ?>