...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <a href="<?php echo e(route("admin.statistics")); ?>" class="block bg-white rounded-lg shadow-lg p-6 hover:shadow-xl hover:scale-105 transition-all duration-200 cursor-pointer">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="<?php echo e(route("admin.statistics")); ?>" class="bg-blue-50 border border-blue-200 rounded-lg p-4 hover:bg-blue-100 transition-colors hover-scale">
                <div class="flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route("admin.statistics")); ?>" class="text-green-600 hover:text-green-700 text-sm font-medium">Ver todos</a>
        </div>
