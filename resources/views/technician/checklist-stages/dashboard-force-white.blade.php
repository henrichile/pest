            ...
            <div class="overflow-hidden rounded-lg bg-white border dark:border-gray-700 border border-gray-200 dark:border-gray-700">
                <div class="p-5">
                    ...
                    @if(($stats['low_stock_alerts'] ?? 0) > 0)
                        ...
                        <a href="{{ route('admin.products.index') ?? '#' }}" class="mt-4 inline-flex items-center justify-center px-4 py-2 rounded-lg transition-colors hover:opacity-90 btn-white-text">
