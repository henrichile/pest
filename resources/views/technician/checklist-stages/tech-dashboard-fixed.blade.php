        ...
        <div class="hidden md:flex md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-x-4 flex-shrink-0">
                ...
                <div class="relative">
                    ...
                    <input type="text" placeholder="Buscar..." class="placeholder:text-gray-400 dark:placeholder:text-gray-500 pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:text-white dark:bg-gray-700 dark:border-gray-600">
                </div>
            ...
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1 text-gray-600 dark:text-white">Completados Hoy</p>
        ...
        <div class="overflow-hidden rounded-xl bg-white border dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1 text-gray-600 dark:text-white">Pendientes</p>
        ...
        <div class="overflow-hidden rounded-xl bg-white border dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1 text-gray-600 dark:text-white">En Progreso</p>
        ...
        <div class="overflow-hidden rounded-xl bg-white border dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1 text-gray-600 dark:text-white">Vencidos</p>
