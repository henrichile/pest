        ...
        <div class="hidden md:flex md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-x-4 flex-shrink-0">
                ...
                <div class="relative">
                    ...
                    <input type="text" placeholder="Buscar..." class="placeholder:text-gray-400 dark:placeholder:text-gray-500 pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
