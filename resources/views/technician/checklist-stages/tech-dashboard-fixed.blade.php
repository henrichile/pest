        ...
        <div class="hidden md:flex md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-x-4 flex-shrink-0">
                ...
                <div class="relative">
                    ...
                    <input type="text" placeholder="Buscar..." class="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" style="background: #ffffff; width: 280px;">
                </div>
            ...
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1" class="text-gray-600 dark:text-gray-300">Completados Hoy</p>
        ...
        <div class="overflow-hidden rounded-xl bg-white border dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow" style="border: 1px solid #e5e7eb !important;">
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1" class="text-gray-600 dark:text-gray-300">Pendientes</p>
        ...
        <div class="overflow-hidden rounded-xl bg-white border dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow" style="border: 1px solid #e5e7eb !important;">
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1" class="text-gray-600 dark:text-gray-300">En Progreso</p>
        ...
        <div class="overflow-hidden rounded-xl bg-white border dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow" style="border: 1px solid #e5e7eb !important;">
            <div class="p-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-xs sm:text-sm font-medium mb-1" class="text-gray-600 dark:text-gray-300">Vencidos</p>
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-4 border-b border-gray-200 last:border-b-0">
                    <div class="flex items-center gap-4 flex-1">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium" class="text-gray-900 dark:text-white">{{ $service->client->name ?? 'N/A' }} - {{ ucfirst(str_replace('-', ' ', $service->service_type ?? 'N/A')) }}</p>
