        ...
        <div class="mb-4 sm:mb-6">
            ...
            <div class="flex items-center gap-3 mb-4 md:hidden" style="padding-top: 2.5rem;">
                ...
                <button id="page-mobile-menu-button"
                    class="flex-shrink-0 p-2 rounded-lg bg-white border border-gray-300 shadow-md hover:bg-gray-50 transition-colors md:hidden"
                    style="z-index: 50;">
            ...
            <div class="mb-4 md:hidden">
                <a href="{{ route('admin.services.create') ?? route('services.create') ?? '#' }}"
                    class="inline-flex items-center justify-center w-full px-4 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-medium transition-colors">
            ...
            <div class="hidden md:flex md:items-center md:justify-between">
                ...
                <div class="mt-3 sm:mt-4 md:mt-0 md:ml-4">
                    <a href="{{ route('admin.services.create') ?? route('services.create') ?? '#' }}"
                        class="inline-flex items-center justify-center w-full sm:w-auto px-3 sm:px-4 py-2 border border-transparent rounded-lg shadow-sm text-xs sm:text-sm font-medium transition-colors">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <div class="flex items-center gap-3 h-full">
                        <button type="submit" id="filter-submit-btn"
                            class="flex-1 px-6 py-3.5 bg-gray-700 hover:bg-gray-800 text-white font-medium rounded-lg shadow-sm transition-colors">
                            Filtrar
                        </button>
                    ...
                    <div class="flex items-center justify-center gap-1 overflow-x-auto w-full">
                        ...
                        @if($startPage > 1)
                            <a href="{{ $services->url(1) }}"
                                class="px-2 py-1.5 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 whitespace-nowrap">1</a>
                            @if($startPage > 2)
                        ...
                        @foreach($services->getUrlRange($startPage, $endPage) as $page => $url)
                            ...
                            @else
                                <a href="{{ $url }}"
                                    class="px-2.5 py-1.5 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 whitespace-nowrap">{{ $page }}</a>
                            @endif
                        @endforeach
                        ...
                        @if($endPage < $lastPage)
                            ...
                            <a href="{{ $services->url($lastPage) }}"
                                class="px-2 py-1.5 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 whitespace-nowrap">{{ $lastPage }}</a>
                        @endif

                        @if($services->hasMorePages())
                            <a href="{{ $services->nextPageUrl() }}"
                                class="px-2 py-1.5 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 whitespace-nowrap">Siguiente
                                »</a>
                        @else
                            <span
                                class="px-2 py-1.5 text-xs sm:text-sm font-medium text-gray-400 cursor-not-allowed whitespace-nowrap">Siguiente
                                »</span>
                        @endif
                    </div>
