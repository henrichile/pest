...
<div class="observations-container">
    ...
    <div class="add-observation-section">
        ...
        <form method="GET" action="{{ route("technician.service.checklist.submit", $service) }}" enctype="multipart/form-data" class="observation-form" id="addObservationFormNEW" style="display: none;">
            @csrf
