                ...
                <a href="{{ getTechnicianRoute('technician.service.checklist.location', $service) }}" 
                   class="geolocation-retry-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20"
                        viewBox="0 0 640 640" fill="currentColor" class="dark:fill-white"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path
