        ...
        <aside id="sidebar" class="fixed md:static flex-shrink-0 w-72 flex flex-col bg-white border-r border-gray-200 z-50 h-full" style="transform: translateX(-100%); transition: transform 0.3s ease-in-out;">
            ...
            <div class="flex grow flex-col gap-y-3 overflow-y-auto px-5 pb-4">
                <div class="flex h-16 shrink-0 items-center justify-center pt-6 pb-4">
                    <a href="{{ route('admin.dashboard') ?? route('dashboard') }}" class="flex items-center justify-center">
                            ...
                            <li>
                                ...
                                <li>
                                    <a href="{{ route('technician-view.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician-view.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('technician-view.dashboard') ? 'color: #111827 !important;' : '' }}">
                                        ...
                                        <span class="{{ request()->routeIs('technician-view.dashboard') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('technician-view.dashboard') ? 'color: #111827 !important;' : '' }}">Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('technician-view.profile') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician-view.profile') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('technician-view.profile') ? 'color: #111827 !important;' : '' }}">
                                        ...
                                        <span class="{{ request()->routeIs('technician-view.profile') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('technician-view.profile') ? 'color: #111827 !important;' : '' }}">Mi Perfil</span>
                                    </a>
                                </li>
                                </ul>
                            </li>
