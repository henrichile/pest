...
<body class="h-full" id="body-element" style="overflow-x: hidden; background: #f9fafb;">
    <div id="app" class="flex h-full flex-row">
        ...
        <button id="mobile-menu-button" class="md:hidden fixed top-3 left-3 z-50 p-2.5 rounded-lg bg-white border border-gray-300 shadow-lg hover:bg-gray-50 transition-colors" style="z-index: 10001; display: none;">
            <svg id="menu-icon" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="text-gray-900 dark:text-white">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
            </svg>
            <svg id="close-icon" class="h-6 w-6 hidden" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="text-gray-900 dark:text-white">
                ...
                <div class="mb-3">
                    <div id="dark-mode-container" class="w-full flex items-center justify-between gap-x-3 rounded-lg py-2.5 px-3 text-xs transition-colors duration-200">
                        <div class="flex items-center gap-x-2">
                            <svg id="dark-mode-icon" class="h-4 w-4 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-gray-600 dark:text-white">
                            ...
                            <li>
                                ...
                                <li>
                                    <a href="{{ route('admin.technician-view.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.technician-view.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('admin.technician-view.dashboard') ? 'color: #111827 !important;' : '' }}">
                                        ...
                                        <span class="{{ request()->routeIs('admin.technician-view.dashboard') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('admin.technician-view.dashboard') ? 'color: #111827 !important;' : '' }}">Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('admin.technician-view.profile') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.technician-view.profile') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('admin.technician-view.profile') ? 'color: #111827 !important;' : '' }}">
                                        ...
                                        <span class="{{ request()->routeIs('admin.technician-view.profile') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('admin.technician-view.profile') ? 'color: #111827 !important;' : '' }}">Mi Perfil</span>
                                    </a>
                                </li>
                                </ul>
                            </li>
                        @else
                            ...
                            @if(auth()->user()->hasRole('super-admin'))
                                ...
                                <li>
                                    ...
                                    <ul role="list" class="-mx-2 space-y-1.5">
                                        <li>
                                            <a href="{{ route('admin.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !(request()->routeIs('dashboard') || request()->routeIs('admin.dashboard')) ? 'color: #111827 !important;' : '' }}">
                                                <svg class="h-5 w-5 shrink-0 {{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') ? 'text-white' : 'text-gray-900 dark:text-gray-400 group-hover:text-white' }}" style="margin-right: 20px !important; {{ !(request()->routeIs('dashboard') || request()->routeIs('admin.dashboard')) ? 'color: #111827 !important;' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
                                                </svg>
                                                <span class="{{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !(request()->routeIs('dashboard') || request()->routeIs('admin.dashboard')) ? 'color: #111827 !important;' : '' }}">Dashboard</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.clients.index') ?? route('clients.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('clients.*') || request()->routeIs('admin.clients.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !(request()->routeIs('clients.*') || request()->routeIs('admin.clients.*')) ? 'color: #111827 !important;' : '' }}">
                                                ...
                                                <span class="{{ request()->routeIs('clients.*') || request()->routeIs('admin.clients.*') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !(request()->routeIs('clients.*') || request()->routeIs('admin.clients.*')) ? 'color: #111827 !important;' : '' }}">Clientes</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.services.index') ?? route('services.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('services.*') || request()->routeIs('admin.services.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !(request()->routeIs('services.*') || request()->routeIs('admin.services.*')) ? 'color: #111827 !important;' : '' }}">
                                                <svg class="h-5 w-5 shrink-0 {{ request()->routeIs('services.*') || request()->routeIs('admin.services.*') ? 'text-white' : 'text-gray-900 dark:text-gray-400 group-hover:text-white' }}" style="margin-right: 20px !important; {{ !(request()->routeIs('services.*') || request()->routeIs('admin.services.*')) ? 'color: #111827 !important;' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5a2.25 2.25 0 002.25-2.25m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5a2.25 2.25 0 012.25 2.25v7.5" />
                                                </svg>
                                                <span class="{{ request()->routeIs('services.*') || request()->routeIs('admin.services.*') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !(request()->routeIs('services.*') || request()->routeIs('admin.services.*')) ? 'color: #111827 !important;' : '' }}">Servicios</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.reports.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.reports.*') || request()->routeIs('reports.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !(request()->routeIs('admin.reports.*') || request()->routeIs('reports.*')) ? 'color: #111827 !important;' : '' }}">
                                                ...
                                                <span class="{{ request()->routeIs('admin.reports.*') || request()->routeIs('reports.*') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !(request()->routeIs('admin.reports.*') || request()->routeIs('reports.*')) ? 'color: #111827 !important;' : '' }}">Reportes</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.users.index', ['role' => 'technician']) }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.users.index') && request()->get('role') === 'technician' ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !(request()->routeIs('admin.users.index') && request()->get('role') === 'technician') ? 'color: #111827 !important;' : '' }}">
                                                ...
                                                <span class="{{ request()->routeIs('admin.users.index') && request()->get('role') === 'technician' ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !(request()->routeIs('admin.users.index') && request()->get('role') === 'technician') ? 'color: #111827 !important;' : '' }}">Técnicos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.pests') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.pests') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('admin.pests') ? 'color: #111827 !important;' : '' }}">
                                                ...
                                                <span class="{{ request()->routeIs('admin.pests') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('admin.pests') ? 'color: #111827 !important;' : '' }}">Plagas</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.products.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.products.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('admin.products.*') ? 'color: #111827 !important;' : '' }}">
                                                ...
                                                <span class="{{ request()->routeIs('admin.products.*') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('admin.products.*') ? 'color: #111827 !important;' : '' }}">Productos</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            @else
                                ...
                                <li>
                                    ...
                                    <ul role="list" class="-mx-2 space-y-1.5">
                                        <li>
                                            <a href="{{ route('technician.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('technician.dashboard') ? 'color: #111827 !important;' : '' }}">
                                                <svg class="h-5 w-5 shrink-0 {{ request()->routeIs('technician.dashboard') ? 'text-white' : 'text-gray-900 dark:text-gray-400 group-hover:text-white' }}" style="margin-right: 20px !important; {{ !request()->routeIs('technician.dashboard') ? 'color: #111827 !important;' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
                                                </svg>
                                                <span class="{{ request()->routeIs('technician.dashboard') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('technician.dashboard') ? 'color: #111827 !important;' : '' }}">Dashboard</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('technician.services') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician.services*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('technician.services*') ? 'color: #111827 !important;' : '' }}">
                                                <svg class="h-5 w-5 shrink-0 {{ request()->routeIs('technician.services*') ? 'text-white' : 'text-gray-900 dark:text-gray-400 group-hover:text-white' }}" style="margin-right: 20px !important; {{ !request()->routeIs('technician.services*') ? 'color: #111827 !important;' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5a2.25 2.25 0 002.25-2.25m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5a2.25 2.25 0 012.25 2.25v7.5" />
                                                </svg>
                                                <span class="{{ request()->routeIs('technician.services*') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('technician.services*') ? 'color: #111827 !important;' : '' }}">Mis Servicios</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('technician.profile') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician.profile') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('technician.profile') ? 'color: #111827 !important;' : '' }}">
                                                ...
                                                <span class="{{ request()->routeIs('technician.profile') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('technician.profile') ? 'color: #111827 !important;' : '' }}">Mi Perfil</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <ul role="list" class="-mx-2 space-y-1.5">
                                <li>
                                    <a href="{{ route('admin.users.index') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.users.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}">
                                        ...
                                        <span class="{{ request()->routeIs('admin.users.*') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('admin.users.*') ? 'color: #111827 !important;' : '' }}">Usuarios</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.notification-center') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.notification-center') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !request()->routeIs('admin.notification-center') ? 'color: #111827 !important;' : '' }}">
                                        ...
                                        <span class="{{ request()->routeIs('admin.notification-center') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !request()->routeIs('admin.notification-center') ? 'color: #111827 !important;' : '' }}">Notificaciones</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ Route::has('admin.settings') ? route('admin.settings') : '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.settings.*') || request()->routeIs('admin.settings') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !(request()->routeIs('admin.settings.*') || request()->routeIs('admin.settings')) ? 'color: #111827 !important;' : '' }}">
                                        ...
                                        <span class="{{ (request()->routeIs('admin.settings.*') || request()->routeIs('admin.settings')) ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !(request()->routeIs('admin.settings.*') || request()->routeIs('admin.settings')) ? 'color: #111827 !important;' : '' }}">Configuraciones</span>
                                    </a>
                                </li>
                                {{-- <li>
