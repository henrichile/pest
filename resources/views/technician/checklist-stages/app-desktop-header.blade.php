                ...
                <div class="px-6 py-4 flex items-center justify-between gap-4">
                    ...
                    <div class="flex-1 max-w-md">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Buscar..." class="placeholder:text-gray-400 dark:placeholder:text-gray-500 w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        </div>
                    </div>
