                                ...
                                <ul role="list" class="-mx-2 space-y-1.5">
                                    <li>
                                        <a href="{{ auth()->user()->hasRole('super-admin') ? route('admin.dashboard') : route('technician.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') || request()->routeIs('technician.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" style="{{ !(request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') || request()->routeIs('technician.dashboard')) ? 'color: #111827 !important;' : '' }}">
                                            ...
                                            <span class="{{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') || request()->routeIs('technician.dashboard') ? 'text-white' : 'text-gray-900 dark:text-white group-hover:text-white' }}" style="font-size: 15px; font-weight: 500; {{ !(request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') || request()->routeIs('technician.dashboard')) ? 'color: #111827 !important;' : '' }}">Dashboard</span>
                                        </a>
                                    </li>
                                {{-- <li>
                    ...
                    <div class="flex items-center gap-3 flex-shrink-0">
                        ...
                        <div class="relative" id="header-notification-dropdown">
                            <button type="button" id="header-notification-button" class="relative flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-100 transition-colors">
                                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-gray-600 dark:text-white">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
                                </svg>
                                @php
                ...
                <div class="px-6 py-4 flex items-center justify-between gap-4">
                    ...
                    <div class="flex-1 max-w-md">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Buscar..." class="placeholder:text-gray-400 dark:placeholder:text-gray-500 w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:text-white dark:bg-gray-700 dark:border-gray-600">
                        </div>
                    </div>
