...
@section('content')
    <div class="space-y-4 sm:space-y-6 pt-12 md:pt-0">
        ...
        <div class="mb-4 sm:mb-6">
            ...
            <div class="hidden md:block">
                <div class="min-w-0 flex-1">
                    <h2 class="text-3xl font-bold leading-7 text-gray-900 sm:truncate sm:tracking-tight text-gray-900 dark:text-white"
                        class="font-bold">
                        Configuraciones
                    </h2>
        ...
        <!-- Company Settings -->
        <div
            class="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Datos de la Empresa</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="company_name"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Nombre de la Empresa
                            *</label>
                        <input type="text" id="company_name" name="company_name"
                            value="{{ old('company_name', $settings['company_name'] ?? config('app.name')) }}" required
                    ...
                    <!-- Company RUT -->
                    <div>
                        <label for="company_rut"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">RUT</label>
                        <input type="text" id="company_rut" name="company_rut"
                            value="{{ old('company_rut', $settings['company_rut'] ?? '') }}"
                            class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            style="border: 1px solid #e5e7eb !important;">
                    </div>
                    ...
                    <div>
                        <label for="company_address"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Dirección</label>
                    ...
                    <div>
                        <label for="company_phone"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Teléfono</label>
                    ...
                    <div>
                        <label for="company_email"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Email</label>
                    ...
                    <div>
                        <label for="company_logo"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Logo</label>
                        <input type="file" id="company_logo" name="company_logo"
                            accept="image/jpeg,image/png,image/jpg,image/svg+xml"
                            class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            style="border: 1px solid #e5e7eb !important;">
                        <p class="mt-1 text-xs text-gray-600 dark:text-white">Formatos permitidos: JPEG, PNG, JPG, SVG (máx.
                            2MB)</p>
        ...
        <div
            class="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Configuración SMTP</h3>
            ...
            <form action="{{ route('admin.settings.smtp') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- SMTP Host -->
                    <div>
                        <label for="smtp_host" class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Servidor
                            SMTP *</label>
                    ...
                    <!-- SMTP Port -->
                    <div>
                        <label for="smtp_port" class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Puerto
                            *</label>
                        <input type="number" id="smtp_port" name="smtp_port"
                            value="{{ old('smtp_port', config('mail.mailers.smtp.port')) }}" required min="1" max="65535"
                            class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            style="border: 1px solid #e5e7eb !important;">
                    </div>
                    ...
                    <div>
                        <label for="smtp_username"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Usuario *</label>
                        <input type="text" id="smtp_username" name="smtp_username"
                            value="{{ old('smtp_username', config('mail.mailers.smtp.username')) }}" required
                            class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            style="border: 1px solid #e5e7eb !important;">
                    </div>
                    ...
                    <div>
                        <label for="smtp_password"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Contraseña</label>
                        <input type="password" id="smtp_password" name="smtp_password" value="{{ old('smtp_password') }}"
                            class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            style="border: 1px solid #e5e7eb !important;">
                        <p class="mt-1 text-xs text-gray-600 dark:text-white">Dejar en blanco para mantener la contraseña
                            actual</p>
                    </div>
                    ...
                    <div>
                        <label for="smtp_encryption"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Encriptación *</label>
                    ...
                    <div>
                        <label for="smtp_from_address"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Email Remitente *</label>
                        <input type="email" id="smtp_from_address" name="smtp_from_address"
                            value="{{ old('smtp_from_address', config('mail.from.address')) }}" required
                            class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            style="border: 1px solid #e5e7eb !important;">
                    </div>
                    ...
                    <div>
                        <label for="smtp_from_name"
                            class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Nombre Remitente</label>
                        <input type="text" id="smtp_from_name" name="smtp_from_name"
                            value="{{ old('smtp_from_name', config('mail.from.name')) }}"
                            class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            style="border: 1px solid #e5e7eb !important;">
                    </div>
                </div>
