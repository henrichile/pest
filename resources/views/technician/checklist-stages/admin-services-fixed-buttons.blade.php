    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6 mb-6">
        ...
        <form method="GET" action="{{ route('admin.services.index') ?? route('services.index') ?? '#' }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="flex items-end gap-3 col-span-full lg:col-span-3">
                <button type="submit" id="filter-submit-btn" class="flex-1 lg:flex-none px-6 py-3.5 bg-gray-700 hover:bg-gray-800 text-white rounded-lg transition-colors text-base font-medium" style="display: block !important; visibility: visible !important;">
                    Filtrar
                </button>
                <a href="{{ route('admin.services.index') }}" class="flex-1 lg:flex-none px-6 py-3.5 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg transition-colors text-base font-medium text-center" style="display: block !important; visibility: visible !important;">
                    Limpiar
                </a>
            </div>
        </form>
