        ...
        <form method="GET" action="{{ route('admin.users.index') }}" class="space-y-4">
            ...
            <div class="w-full">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Nombre o email..." class="placeholder:text-gray-400 dark:placeholder:text-gray-500 block w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" style="border: 1px solid #e5e7eb !important; color: #111827;padding-left:20px;">
                </div>
            </div>
