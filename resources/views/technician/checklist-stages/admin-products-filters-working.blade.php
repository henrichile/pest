...
<div class="space-y-4 sm:space-y-6 pt-12 md:pt-0">
    ...
    <div class="flex justify-end mb-4">
        <a href="{{ route("admin.products.create") }}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent rounded-lg shadow-sm text-base font-medium dark:text-white bg-green-600 hover:bg-green-700 transition-colors">
