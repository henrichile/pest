...
<div class="min-h-screen bg-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @if($service->checklist_data)
            <!-- Etapa 1: Puntos de Control - Oculto para desinsectación, desinfección, sanitizacion, desratización y servicios-especiales -->
            @if($service->service_type !== 'desinsectacion' && $service->service_type !== 'desinfeccion' && $service->service_type !== 'sanitizacion' && $service->service_type !== 'desratizacion' && $service->service_type !== 'servicios-especiales')
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
