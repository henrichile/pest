                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-3">
                                        @foreach($checklistData['monitoreo_datos']['service_photos'] as $photo)
                                            ...
                                            @endphp
                                            <img src="{{ $photoPath }}" alt="Foto del servicio"
                                                class="rounded-lg border border-gray-200 w-full h-48 object-cover">
                                        @endforeach
                                    </div>
                                </div>
                            @endif
                            ...
                            @if(isset($checklistData['monitoreo_croquis']['croquis_file']))
                                <div class="mb-4">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        @endphp
                                        <img src="{{ $croquisPath }}" alt="Croquis de cebaderas"
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                            ...
                            @if(isset($checklistData['monitoreo_completo']['monitoring_date']))
                                <div class="mb-4">
                                    ...
                                    <span
                                        class="text-gray-700 dark:text-white ml-2">{{ \Carbon\Carbon::parse($checklistData['monitoreo_completo']['monitoring_date'])->format('d/m/Y') }}</span>
                                </div>
                            @endif
                            ...
                            @if(isset($checklistData['monitoreo_completo']['total_bait_stations']))
                                <div class="mb-4">
                                    ...
                                    <span
                                        class="text-gray-700 dark:text-white ml-2">{{ $checklistData['monitoreo_completo']['total_bait_stations'] }}</span>
                                </div>
                            @endif
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                                                    ...
                                                    @if(isset($station['product_type']))
                                                        <div>
                                                            ...
                                                            <span
                                                                class="text-gray-900 dark:text-white ml-2">{{ ucfirst($station['product_type']) }}</span>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if(isset($station['quantity']))
                                                        <div>
                                                            ...
                                                            <span class="text-gray-900 dark:text-white ml-2">{{ $station['quantity'] }}
                                                                {{ $station['unit'] ?? 'g' }}</span>
                                                        </div>
                                                    @endif
                                                </div>
                                                        ...
                                                        <ul class="mt-2 space-y-1">
                                                            @foreach($station['observations'] as $obs)
                                                                <li class="flex items-center text-gray-700 dark:text-white text-sm">
                                                                    <svg width="20" height="20" class="text-yellow-500 mr-2" fill="currentColor"
                                                                        viewBox="0 0 20 20">
                                                                        <path fill-rule="evenodd"
                                                                            d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                                                                            clip-rule="evenodd"></path>
                                                        ...
                                                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mt-2">
                                                            @foreach($station['photos'] as $photo)
                                                                ...
                                                                <div class="photo-item">
                                                                    <img src="{{ $photoPath }}" alt="Foto de cebadera {{ $station['code'] ?? '' }}"
                                            ...
                                            <div class="border border-gray-200 rounded-lg p-4 bg-gray-50 dark:bg-gray-700">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                                                    ...
                                                    @if(isset($trap['product_type']))
                                                        <div>
                                                            <span
                                                                class="text-sm font-medium text-gray-600 dark:text-white">Producto/Material:</span>
                                                            <span
                                                                class="text-gray-900 dark:text-white ml-2">{{ ucfirst($trap['product_type']) }}</span>
                                                        </div>
                                                    @endif
                                                        ...
                                                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mt-2">
                                                            @foreach($trap['photos'] as $photo)
                                                                ...
                                                                <img src="{{ asset($photoPath) }}"
                                                                    alt="Foto de trampa {{ $trap['code'] ?? ($index + 1) }}"
                    ...
                    @php
                        ...
                        if ($statsAreEmpty && isset($checklistData['monitoreo_completo'])) {
                            ...
                            foreach ($baitStations as $station) {
                                ...
                                // Verificar problemas
                                if (
                                    in_array('bloqueada', $observations) ||
                    ...
                    @if(isset($checklistData['results']))
                        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                            ...
                            @if(isset($checklistData['results']['observed_results']) && count($checklistData['results']['observed_results']) > 0)
                                <div class="mb-4">
                                    <strong class="text-gray-900 dark:text-black">Resultados Observados:</strong>
                                    <div class="flex flex-wrap gap-2 mt-2">
                                        @foreach($checklistData['results']['observed_results'] as $result)
                                            <span
                                                class="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-medium dark:text-black">{{ ucfirst(str_replace('_', ' ', $result)) }}</span>
                                        @endforeach
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                        <div class="flex items-start justify-between mb-2">
                                            ...
                                            @if(isset($observation['created_at']))
                                                <span
                                                    class="text-xs text-gray-500 dark:text-black">{{ \Carbon\Carbon::parse($observation['created_at'])->format('d/m/Y H:i') }}</span>
                                            @endif
                                        </div>
                                        @if(isset($observation['detail']) && !empty($observation['detail']))
                                            <p class="text-gray-700 dark:text-black">{{ $observation['detail'] }}</p>
                                        @endif
                                        @if(isset($observation['complementary']) && !empty($observation['complementary']))
                                            <p class="text-sm text-gray-600 mt-2 italic dark:text-black">{{ $observation['complementary'] }}</p>
                                        @endif
                                        @if(isset($observation['photo']))
                                            ...
                                            @endphp
                                            <div class="mt-3">
                                                <img src="{{ $photoPath }}" alt="Foto de observación"
                                                    class="rounded-lg border border-gray-200 max-w-xs h-auto">
                                            </div>
                                        @endif
                                    </div>
                                @endforeach
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                            ...
                            @if(isset($checklistData['description']['completion_date']))
                                <div class="mb-4">
                                    ...
                                    <span
                                        class="text-gray-700 dark:text-white ml-2">{{ \Carbon\Carbon::parse($checklistData['description']['completion_date'])->format('d/m/Y') }}</span>
                                </div>
                            @endif
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                        @if(isset($checklistData['description']['technician_signature']))
                                            <div class="text-center">
                                                ...
                                                <div class="bg-white rounded-lg border-2 border-gray-200 p-3 inline-block">
                                                    <img src="{{ $checklistData['description']['technician_signature'] }}"
                                                        alt="Firma del Técnico" class="max-w-[200px] h-auto">
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if(isset($checklistData['description']['client_signature']))
                                            <div class="text-center">
                                                ...
                                                <div class="bg-white rounded-lg border-2 border-gray-200 p-3 inline-block">
                                                    <img src="{{ $checklistData['description']['client_signature'] }}" alt="Firma del Cliente"
