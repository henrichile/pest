...
@section("title", "Editar Usuario - Pest Controller SAT")
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <select id="role" name="role" required
                        ...
                        <option value="super-admin" {{ old("role", $user->roles->first()->name ?? "") == "super-admin" ? "selected" : "" }}>Super Administrador</option>
                        <option value="technician" {{ old("role", $user->roles->first()->name ?? "") == "technician" ? "selected" : "" }}>Técnico</option>
                    </select>
                    @error("role")
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
