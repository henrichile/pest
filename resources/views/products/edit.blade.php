    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="mb-6">
                ...
                <p class="text-gray-600 dark:text-white">Modifica la información del producto</p>
            </div>
        ...
        <form method="POST" action="{{ route("admin.products.update", $product) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" required
                           ...
                           class="w-full border border-gray-300 dark:text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 @error("name") border-red-500 @enderror">
                    @error("name")
                ...
                <!-- Stock -->
                <div>
                    <label for="stock" class="block text-sm font-medium text-gray-700 mb-2 dark:text-white">Stock Actual *</label>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          ...
                          class="w-full border border-gray-300 rounded-lg dark:text-white px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 @error("description") border-red-500 @enderror">{{ old("description", $product->description) }}</textarea>
                @error("description")
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route("admin.products.show", $product) }}" 
                   class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors dark:border-gray-700 dark:text-white dark:hover:bg-gray-700">
                    Cancelar
                </a>
                <button type="submit" 
