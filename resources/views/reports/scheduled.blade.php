...
<div class="max-w-full mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold" style="color: #111827;">Reportes Programados</h1>
                <p class="text-sm mt-1" style="color: #6b7280;">Gestiona y visualiza los reportes programados automáticamente</p>
            </div>
        ...
        <div class="p-6">
            @if($scheduledReports->isEmpty())
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-semibold" style="color: #111827;">No hay reportes programados</h3>
                    <p class="mt-1 text-sm" style="color: #6b7280;">Comienza programando tu primer reporte automático.</p>
                    <div class="mt-6">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium" style="color: #111827;">{{ $report->name }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm" style="color: #111827;">
                                    ...
                                    @else
                                        <span style="color: #6b7280;">No programado</span>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm" style="color: #111827;">
                                    ...
                                    @else
                                        <span style="color: #6b7280;">Sin destinatarios</span>
                                    @endif
                                </td>
