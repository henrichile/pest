...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold" style="color: #111827;">Programar Nuevo Reporte</h1>
                <p class="text-sm mt-1" style="color: #6b7280;">Configura un reporte que se generará automáticamente según la frecuencia seleccionada</p>
            </div>
    ...
    <form action="{{ route('admin.reports.scheduled.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md border p-6" style="border: 1px solid #e5e7eb;">
            ...
            <p class="text-sm mb-4" style="color: #6b7280;">Los filtros se aplicarán automáticamente al generar el reporte. Si no se especifican, se usarán los valores predeterminados.</p>
        ...
        <div class="bg-white rounded-lg shadow-md border p-6" style="border: 1px solid #e5e7eb;">
            ...
            <div>
                ...
                <input type="text" name="recipients" id="recipients" value="{{ old('recipients') }}"
                       ...
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                <p class="mt-1 text-xs" style="color: #6b7280;">Si se especifican emails, el reporte se enviará automáticamente a estos destinatarios cuando se genere.</p>
            </div>
        </div>
