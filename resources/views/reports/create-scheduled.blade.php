...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold" class="text-gray-900 dark:text-white">Programar Nuevo Reporte</h1>
                <p class="text-sm mt-1" class="text-gray-600 dark:text-gray-300">Configura un reporte que se generará automáticamente según la frecuencia seleccionada</p>
            </div>
    ...
    <form action="{{ route('admin.reports.scheduled.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md border p-6" style="border: 1px solid #e5e7eb;">
            ...
            <div class="space-y-4">
                <div>
                    <label for="name" class="block text-sm font-medium mb-2" class="text-gray-600 dark:text-gray-300">Nombre del Reporte *</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="type" class="block text-sm font-medium mb-2" class="text-gray-600 dark:text-gray-300">Tipo de Reporte *</label>
                    ...
                    <div>
                        <label for="format" class="block text-sm font-medium mb-2" class="text-gray-600 dark:text-gray-300">Formato *</label>
                ...
                <div>
                    <label for="frequency" class="block text-sm font-medium mb-2" class="text-gray-600 dark:text-gray-300">Frecuencia *</label>
        ...
        <!-- Filtros -->
        <div class="bg-white rounded-lg shadow-md border p-6" style="border: 1px solid #e5e7eb;">
            <h3 class="text-lg font-semibold mb-4" class="text-gray-900 dark:text-white">Filtros (Opcional)</h3>
            <p class="text-sm mb-4" class="text-gray-600 dark:text-gray-300">Los filtros se aplicarán automáticamente al generar el reporte. Si no se especifican, se usarán los valores predeterminados.</p>
        ...
        <!-- Destinatarios -->
        <div class="bg-white rounded-lg shadow-md border p-6" style="border: 1px solid #e5e7eb;">
            <h3 class="text-lg font-semibold mb-4" class="text-gray-900 dark:text-white">Destinatarios (Opcional)</h3>
            <div>
                <label for="recipients" class="block text-sm font-medium mb-2" class="text-gray-600 dark:text-gray-300">Emails (separados por comas)</label>
                <input type="text" name="recipients" id="recipients" value="{{ old('recipients') }}"
                       placeholder="email1@ejemplo.com, email2@ejemplo.com"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                <p class="mt-1 text-xs" class="text-gray-600 dark:text-gray-300">Si se especifican emails, el reporte se enviará automáticamente a estos destinatarios cuando se genere.</p>
            </div>
        </div>
