            ...
            <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-900">
                                    {{ $report->service->service_type ?? "Desratización" }}
                                </p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Técnico</p>
                                <p class="font-medium text-gray-900">{{ $report->service->assignedUser->name ?? "N/A" }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($report->report_data && isset($report->report_data["checklist_data"]))
                        <div class="mb-6">
                            <h4 class="text-lg font-semibold text-gray-800 mb-4">Resumen del Reporte</h4>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    @if(isset($report->report_data["checklist_data"]["products"]))
                                        <div>
                                            ...
                                            <p class="font-medium text-gray-900">
                                                {{ $report->report_data["checklist_data"]["products"]["applied_product"] ?? "N/A" }}
                                            </p>
                                        </div>
                                    @endif
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-900">
                                            {{ $report->report_data["observations_count"] ?? 0 }} registradas
                                        </p>
                                    </div>
                                    <div>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700 mt-1">
                                    Este reporte ha sido validado digitalmente y contiene un código QR único para
                                    verificación.
