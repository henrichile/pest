...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold" class="text-gray-900 dark:text-white">Editar Reporte Programado</h1>
                <p class="text-sm mt-1" class="text-gray-600 dark:text-gray-300">Modifica la configuración del reporte programado</p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-medium" class="text-gray-600 dark:text-gray-300">Reporte activo</span>
                    </label>
                </div>
            </div>
        </div>
