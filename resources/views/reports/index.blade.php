...
<div class="space-y-4 sm:space-y-6 pt-3 md:pt-0">
            ...
            <form method="GET" action="{{ route('admin.reports.index') }}" id="reportFiltersForm">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button type="button" class="quick-range-btn px-4 py-2 rounded-full text-sm font-medium transition-colors" data-range="this-month" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                        ...
                        <button type="button" class="quick-range-btn px-4 py-2 rounded-full text-sm font-medium transition-colors" data-range="last-month" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                            <svg class="w-4 h-4 inline mr-1" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                            </svg>
                            Último Mes
                        </button>
                        <button type="button" class="quick-range-btn px-4 py-2 rounded-full text-sm font-medium transition-colors" data-range="last-3-months" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                            <svg class="w-4 h-4 inline mr-1" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                            </svg>
                            Últimos 3 Meses
                        </button>
                        <button type="button" class="quick-range-btn px-4 py-2 rounded-full text-sm font-medium transition-colors" data-range="this-year" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                            <svg class="w-4 h-4 inline mr-1" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                            </svg>
                            Este Año
    ...
    <div class="flex gap-3 mb-6">
        <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
        ...
        <div class="relative">
            <button type="button" id="exportBtn" class="px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 hover:bg-gray-100" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="{{ route('admin.reports.scheduled') }}" class="px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 hover:bg-gray-100" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5a2.25 2.25 0 002.25-2.25m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5a2.25 2.25 0 012.25 2.25v7.5" />
            </svg>
            Programados
        </a>
        <a href="{{ route('admin.reports.config') }}" class="px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 hover:bg-gray-100" class="bg-gray-100 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
