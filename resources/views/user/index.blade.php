...
<div class="space-y-4 sm:space-y-6 pt-3 md:pt-0">
    ...
    <div class="mb-4 sm:mb-6">
        ...
        <div class="mt-3 sm:mt-4 md:mt-0 md:ml-4 md:flex md:items-center" style="float: right;">
            <a href="{{ route('admin.users.create') }}" class="inline-flex items-center justify-center w-full sm:w-auto px-3 sm:px-4 py-2 border border-transparent rounded-lg shadow-sm text-xs sm:text-sm font-medium dark:text-white transition-colors dark:border-gray-700" >
    ...
    <div class="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg p-4 mb-6 border border-gray-200 dark:border-gray-700" style="margin-top: 70px">
        ...
        <form method="GET" action="{{ route('admin.users.index') }}" id="filter-form" class="flex flex-col md:flex-row flex-wrap gap-4 md:items-end">
            ...
            <div class="w-full md:flex-1 md:min-w-[200px]">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none dark:text-white">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                        </svg>
                    </div>
                    <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Nombre o email..." class="placeholder:text-gray-400 dark:placeholder:text-gray-500 block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:text-white dark:bg-gray-700 dark:border-gray-600" style="border: 1px solid #e5e7eb !important; padding-left: 40px;">
                </div>
            </div>
            ...
            <div class="w-full md:w-auto flex gap-2">
                <!-- Submit Button -->
                <button type="submit" class="flex-1 md:flex-none inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium dark:text-white transition-colors">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-white divide-y divide-gray-200 dark:divide-gray-700 ">
                    @forelse($users as $user)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-20">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex flex-wrap gap-1">
                                    ...
                                    @if($user->roles->isEmpty())
                                        <span class="text-xs text-gray-400 dark:text-gray-500 dark:text-white">Sin rol</span>
                                    @endif
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
