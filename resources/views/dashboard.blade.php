...
@section('content')
    ...
    <div class="space-y-4 sm:space-y-6 pt-3 md:pt-0">
        ...
        <div class="mb-4 sm:mb-6">
            ...
            <div class="flex items-center gap-3 mb-4 md:hidden">
                ...
                <button id="dashboard-mobile-menu-button"
                    class="flex-shrink-0 p-2 rounded-lg bg-white border border-gray-300 shadow-md hover:bg-gray-50 transition-colors">
                    <svg id="dashboard-menu-icon" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="text-gray-900 dark:text-white">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                    </svg>
                    <svg id="dashboard-close-icon" class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="text-gray-900 dark:text-white">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('admin.notification-center') ?? '#' }}"
                        ...
                        @if(isset($unreadCount) && $unreadCount > 0)
                            <span
                                class="absolute top-0 right-0 block h-2 w-2 rounded-full bg-red-500 ring-2 ring-white transform translate-x-1/4 -translate-y-1/4"></span>
                        @endif
                    </a>

                    <a href="{{ Route::has('admin.profile') ? route('admin.profile') : (Route::has('profile') ? route('profile') : '#') }}"
                        class="flex-shrink-0">
                        <div
            ...
            <div class="hidden md:flex md:items-center md:justify-between gap-4">
                <div class="min-w-0 flex-1">
                    <h2 class="text-2xl sm:text-3xl font-bold leading-7 text-gray-900 sm:truncate sm:tracking-tight text-gray-900 dark:text-white"
                        class="font-bold">
                        Dashboard
                    </h2>
                ...
                <div class="relative global-search-container flex-shrink-0">
                    <div class="relative">
                        <svg class="absolute"
                            style="left: 10px; top: 50%; transform: translateY(-50%); width: 18px; height: 18px; color: #9ca3af; pointer-events: none; z-index: 1;"
                ...
                <div class="flex items-center gap-x-2 sm:gap-x-4 flex-shrink-0">
                    ...
                    <div class="relative notification-dropdown" id="notification-dropdown">
                        <button type="button"
                            class="flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 relative"
                            title="Notificaciones" id="notification-button">
                        ...
                        <div class="notification-menu" id="notification-menu">
                            <div class="notification-menu-header">
                                ...
                                <a href="{{ route('admin.notification-center') ?? '#' }}"
                                    class="text-green-500 text-sm font-medium no-underline">Ver todas</a>
                            </div>
                            <div class="notification-menu-content">
                                ...
                                @else
                                    <div class="notification-empty">
                                        <p class="text-gray-600 dark:text-white text-sm text-center p-5">No hay notificaciones
                                        </p>
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="relative user-menu-dropdown" id="user-menu-dropdown">
                        <button type="button"
                            class="flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors"
                            id="user-menu-button" title="Menú de usuario">
                        ...
                        <div class="user-menu" id="user-menu">
                            <div class="user-menu-header">
                                <div class="user-menu-profile">
                                    <img src="{{ auth()->user()->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name ?? 'Usuario') . '&background=22c55e&color=fff' }}"
                                        alt="{{ auth()->user()->name }}" class="user-menu-avatar">
                            ...
                            <div class="user-menu-content">
                                <a href="{{ Route::has('admin.profile') ? route('admin.profile') : (Route::has('profile') ? route('profile') : '#') }}"
                                    ...
                                    <svg class="user-menu-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <a href="{{ Route::has('admin.settings') ? route('admin.settings') : (Route::has('settings') ? route('settings') : '#') }}"
                                    class="user-menu-item">
                                    <svg class="user-menu-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="md:hidden flex flex-col gap-4 mb-4">
                ...
                <div class="relative global-search-container w-full">
                    <div class="relative">
                        ...
                        <input type="text" id="global-search-input-mobile" placeholder="Buscar servicios, clientes..."
                            class="w-full pr-3 py-2 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all text-sm sm:text-base dark:text-white dark:border-gray-600"
                            style="padding-left: 2rem;" autocomplete="off" />
                    </div>
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-6">
        <!-- Clientes -->
        <div
            class="overflow-hidden rounded-lg bg-white border dark:border-gray-700 border border-gray-200 dark:border-gray-700">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-14 h-14 rounded-lg flex items-center justify-center bg-blue-500">
                            <svg class="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <!-- Estadísticas -->
        <div class="lg:col-span-2 overflow-hidden rounded-lg bg-white border dark:border-gray-700"
            style="border: 1px solid #e5e7eb !important; min-width: 0; grid-column: span 2 / span 2;">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold flex items-center gap-2 dark:text-white" id="statistics-title"
                ...
                <div class="mb-4 flex items-center justify-between flex-wrap gap-3">
                    <div class="flex items-center gap-4 flex-wrap">
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-sm font-semibold statistics-number text-gray-900 dark:text-white">{{ $stats['total_services'] ?? 0 }}</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full bg-green-500"></div>
                            <span class="text-sm statistics-text dark:text-white">Completados</span>
                            <span
                                class="text-sm font-semibold statistics-number text-gray-900 dark:text-white">{{ $stats['completed'] ?? 0 }}</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full bg-red-500"></div>
                            <span class="text-sm statistics-text dark:text-white">Pendientes</span>
                            <span
                                class="text-sm font-semibold statistics-number text-gray-900 dark:text-white">{{ $stats['pending'] ?? 0 }}</span>
                        </div>
                    </div>
                    <select id="periodFilter"
                        class="text-sm border dark:border-gray-700 rounded-md px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-green-500 dark:text-white dark:bg-gray-800"
                        class="text-gray-600 dark:text-white border border-gray-200 dark:border-gray-700 cursor-pointer dark:text-white dark:bg-gray-700 dark:border-gray-600">
                        <option value="this_month" {{ request('period', 'this_month') == 'this_month' ? 'selected' : '' }}>
                            Este Mes</option>
                        <option value="last_month" {{ request('period') == 'last_month' ? 'selected' : '' }}>Último Mes
                        </option>
                        <option value="last_3_months" {{ request('period') == 'last_3_months' ? 'selected' : '' }}>Últimos 3
                            Meses</option>
                        <option value="last_6_months" {{ request('period') == 'last_6_months' ? 'selected' : '' }}>Últimos 6
                            Meses</option>
                        ...
                        <option value="all_time" {{ request('period') == 'all_time' ? 'selected' : '' }}>Todo el Tiempo
                        </option>
                    </select>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        @foreach($serviceTypesCards as $typeSlug => $typeInfo)
                            ...
                            @endphp
                            <div
                                class="bg-white border dark:border-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center gap-2 mb-2">
                                    <svg class="w-5 h-5 text-gray-900 dark:text-gray-400 group-hover:text-white" fill="none"
        ...
        <div class="space-y-6" style="grid-column: span 1 / span 1;">
            ...
            <div
                ...
                <div class="p-5">
                    ...
                    <p class="text-3xl font-bold mb-2 text-gray-900 dark:text-white">
                        ${{ number_format($stats['monthly_income'] ?? 0, 0, ',', '.') }}</p>
                    <p class="text-sm mb-3 dark:text-white">{{ $stats['this_month_completed'] ?? $stats['completed'] ?? 0 }}
                        servicios completados</p>
                    <div class="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-gray-700">
                        <span class="text-sm dark:text-white">Promedio:</span>
                        <span
                            class="text-sm font-semibold text-gray-900 dark:text-white">${{ number_format(($stats['monthly_income'] ?? 0) / max($stats['this_month_completed'] ?? $stats['completed'] ?? 1, 1), 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="p-5">
                    ...
                    <p class="text-4xl font-bold mb-2 text-gray-900 dark:text-white">{{ $stats['low_stock_alerts'] ?? 0 }}
                    </p>
                    ...
                    @if(($stats['low_stock_alerts'] ?? 0) > 0)
                        <p class="text-xs flex items-center gap-1 dark:text-white">
                            <svg class="w-4 h-4 text-gray-900 dark:text-gray-400 group-hover:text-white" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                            </svg>
                    ...
                    <div class="p-5">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('admin.services.create') ?? '#' }}"
                                class="relative rounded-lg bg-white border dark:border-gray-700 px-4 py-3 flex items-center space-x-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border border-gray-200 dark:border-gray-700">
                                <div class="flex-shrink-0">
                            ...
                            <a href="{{ route('admin.clients.create') ?? route('clients.create') }}"
                                class="relative rounded-lg bg-white border dark:border-gray-700 px-4 py-3 flex items-center space-x-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border border-gray-200 dark:border-gray-700">
                                <div class="flex-shrink-0">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider dark:text-white">
                                    CLIENTE</th>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider dark:text-white">
                                    TIPO</th>
