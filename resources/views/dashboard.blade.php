...
@section("title", "Dashboard - Pest Controller SAT")
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route("admin.services.create") }}" class="bg-red-50 border border-red-200 rounded-lg p-4 hover:bg-red-100 transition-colors hover-scale">
                <div class="flex items-center">
            ...
            <a href="{{ route("admin.clients.create") }}" class="bg-green-50 border border-green-200 rounded-lg p-4 hover:bg-green-100 transition-colors hover-scale">
                <div class="flex items-center">
            ...
            <a href="{{ route("admin.services.index") }}" class="bg-blue-50 border border-blue-200 rounded-lg p-4 hover:bg-blue-100 transition-colors hover-scale">
                <div class="flex items-center">
