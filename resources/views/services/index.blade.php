...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route("admin.services.create") }}" 
           class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors dark:text-white dark:bg-green-600 dark:hover:bg-green-700">
