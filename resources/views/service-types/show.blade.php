        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <span
                            class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $serviceType->is_active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800" }}">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-500">Templates de Servicio</label>
                            ...
                            <tbody class="bg-white dark:bg-white divide-y divide-gray-200">
                                @foreach($serviceType->services as $service)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{ $service->scheduled_date ? $service->scheduled_date->format("d/m/Y") : "N/A" }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $service->status === "completado" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800" }}">
            ...
            <div class="mt-6 bg-white shadow rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    <h3 class="text-lg font-medium text-gray-900">Templates de servicio</h3>
                ...
                @else
                    <div class="px-6 py-8 text-center">
                        ...
                        <h4 class="text-lg font-medium text-gray-900 mb-2">No hay templates de servicio</h4>
                        <p class="text-gray-500 mb-4">Crea un template para este tipo de servicio para estandarizar los
                            servicios.</p>
                        <a href="{{ route('admin.checklist-templates.create') }}?service_type_id={{ $serviceType->id }}"
