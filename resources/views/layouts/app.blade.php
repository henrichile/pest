                            ...
                            <li>
                                ...
                                <li>
                                    <a href="{{ route('admin.technician-view.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.technician-view.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                        ...
                                        <span class="{{ request()->routeIs('admin.technician-view.dashboard') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.technician-view.services') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.technician-view.services') || request()->routeIs('admin.technician-view.service.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                        ...
                                        <span class="{{ request()->routeIs('admin.technician-view.services') || request()->routeIs('admin.technician-view.service.*') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Mis Servicios</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.technician-view.profile') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.technician-view.profile') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                        ...
                                        <span class="{{ request()->routeIs('admin.technician-view.profile') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Mi Perfil</span>
                                    </a>
                                </li>
                                </ul>
                            </li>
                                    ...
                                    <ul role="list" class="-mx-2 space-y-1.5">
                                        <li>
                                            <a href="{{ route('admin.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Dashboard</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.clients.index') ?? route('clients.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('clients.*') || request()->routeIs('admin.clients.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('clients.*') || request()->routeIs('admin.clients.*') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Clientes</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.services.index') ?? route('services.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('services.*') || request()->routeIs('admin.services.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('services.*') || request()->routeIs('admin.services.*') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Servicios</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.reports.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.reports.*') || request()->routeIs('reports.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('admin.reports.*') || request()->routeIs('reports.*') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Reportes</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.users.index', ['role' => 'technician']) }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.users.index') && request()->get('role') === 'technician' ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('admin.users.index') && request()->get('role') === 'technician' ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Técnicos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.pests') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.pests') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                <svg class="h-5 w-5 shrink-0 {{ request()->routeIs('admin.pests') ? 'text-white' : 'text-gray-900 dark:text-gray-400 group-hover:text-white' }}"  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                ...
                                                <span class="{{ request()->routeIs('admin.pests') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Plagas</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.products.index') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.products.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('admin.products.*') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Productos</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul role="list" class="-mx-2 space-y-1.5">
                                        <li>
                                            <a href="{{ route('technician.dashboard') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician.dashboard') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('technician.dashboard') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Dashboard</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('technician.services') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician.services*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('technician.services*') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Mis Servicios</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('technician.profile') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('technician.profile') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                                ...
                                                <span class="{{ request()->routeIs('technician.profile') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Mi Perfil</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <ul role="list" class="-mx-2 space-y-1.5">
                                <li>
                                    <a href="{{ route('admin.users.index') }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.users.*') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}">
                                        ...
                                        <span class="{{ request()->routeIs('admin.users.*') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Usuarios</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.notification-center') ?? '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.notification-center') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                        ...
                                        <span class="{{ request()->routeIs('admin.notification-center') ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Notificaciones</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ Route::has('admin.settings') ? route('admin.settings') : '#' }}" class="group flex items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium {{ request()->routeIs('admin.settings.*') || request()->routeIs('admin.settings') ? 'bg-green-500 text-white' : 'text-gray-900 dark:text-gray-300 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-800' }}" >
                                        ...
                                        <span class="{{ (request()->routeIs('admin.settings.*') || request()->routeIs('admin.settings')) ? 'text-white' : 'text-gray-900 dark:text-gray-300 group-hover:text-white' }}" >Configuraciones</span>
                                    </a>
                                </li>
                                {{-- <li>
                ...
                <div class="mt-auto pt-4 border-t border-gray-200">
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button type="submit" class="group flex w-full items-center gap-x-6 rounded-md px-3 py-3 text-sm leading-5 font-medium text-gray-900 dark:text-gray-300 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400 transition-colors">
                            ...
                            <span class="text-gray-900 dark:text-gray-300 group-hover:text-red-600 dark:group-hover:text-red-400" >Cerrar Sesión</span>
                        </button>
                    </form>
                </div>
            </div>
