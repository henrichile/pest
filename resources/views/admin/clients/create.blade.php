    ...
    <div class="mb-4 sm:mb-6">
        ...
        <div class="hidden md:flex md:items-center md:justify-between">
            ...
            <div class="mt-4 md:mt-0 md:ml-4">
                <a href="{{ route('admin.clients.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium transition-colors dark:text-white dark:bg-gray-700 dark:hover:bg-gray-600">
