...
<div class="space-y-4 sm:space-y-6 pt-12 md:pt-0">
    ...
    <div class="mb-4 sm:mb-6">
        <div class="relative">
            ...
            <input type="text" id="search-input" class="block w-full pl-9 sm:pl-10 pr-3 py-2 sm:py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" style="border: 1px solid #e5e7eb !important; color: #111827;" placeholder="Buscar por nombre..." value="{{ request('search') }}">
        </div>
    </div>
