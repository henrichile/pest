...
<div class="space-y-4 sm:space-y-6 pt-3 md:pt-0">
    ...
    <div class="mb-4 sm:mb-6">
        <div class="relative">
            ...
            <input type="text" id="search-input" class="block w-full pr-3 py-2 sm:py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" style="border: 1px solid #e5e7eb !important; color: #111827; padding-left: 2.75rem !important;" placeholder="Buscar por nombre..." value="{{ request('search') }}">
        </div>
    </div>
