...
<div class="space-y-4 sm:space-y-6 pt-3 md:pt-0">
    ...
    <div class="mb-4 sm:mb-6">
        ...
        <div class="flex items-center gap-3 mb-4 md:hidden" style="padding-top: 2.5rem;">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.pests.create') }}" class="flex items-center justify-center h-9 w-9 rounded-full bg-green-600 dark:text-white shadow-sm hover:bg-green-700 transition-colors" aria-label="Crear Nueva Plaga">
        ...
        <div class="hidden md:flex md:items-center md:justify-between">
            ...
            <div class="mt-3 sm:mt-4 md:mt-0 md:ml-4">
                <a href="{{ route('admin.pests.create') }}" class="inline-flex items-center justify-center w-full sm:w-auto px-3 sm:px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-xs sm:text-sm font-medium text-gray-900 dark:text-white transition-colors">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                    <span class="hidden sm:inline text-gray-900 dark:text-white">Crear Nueva Plaga</span>
                    <span class="sm:hidden text-gray-900 dark:text-white">Nueva Plaga</span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="mb-4 sm:mb-6">
        <div class="relative">
            ...
            <input type="text" id="search-input" class="block w-full pr-3 py-2 sm:py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:text-white dark:bg-gray-700 dark:border-gray-600" style="border: 1px solid #e5e7eb !important; color: #111827; padding-left: 2.75rem !important;" placeholder="Buscar por nombre..." value="{{ request('search') }}">
        </div>
    </div>
