...
@section("title", "Gestión de etapas de Servicios")
        ...
        <div class="space-y-6 pt-3 md:pt-0">
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <div class="flex items-center gap-3 mb-4 md:hidden" style="padding-top: 2.5rem;">
                    ...
                    <button id="page-mobile-menu-button"
                        class="flex-shrink-0 p-2 rounded-lg bg-white border border-gray-300 shadow-md hover:bg-gray-50 transition-colors cursor-pointer"
                        style="z-index: 100;">
                    ...
                    <div class="flex-1">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white" class="font-bold">
                            Gestión de etapas de Servicios
                        </h2>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ Route::has('admin.profile') ? route('admin.profile') : (Route::has('profile') ? route('profile') : '#') }}"
                            ...
                            <div
                                ...
                                <span
                                    class="dark:text-white font-medium text-base">{{ substr(auth()->user()->name ?? 'U', 0, 1) }}</span>
                            </div>
                        </a>
                        <!-- Logout -->
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="hidden md:flex items-center justify-between mb-6">
                    <h1 class="text-2xl font-bold text-gray-900">Gestión de etapas de Servicios</h1>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <h3 class="text-lg font-semibold text-blue-800 mb-2">Gestión de etapas de Servicios</h3>
                    <p class="text-blue-700">Aquí podrás crear, editar y administrar las etapas de los servicios.</p>
                    <ul class="mt-3 text-blue-700 space-y-1">
                        <li>• Crear nuevas etapas</li>
                        <li>• Asignar items y etapas</li>
                        <li>• Gestionar estado activo/inactivo</li>
                    </ul>
                </div>

                <div class="text-center py-8">
                    <p class="text-gray-500">Módulo completamente funcional con gestión de etapas de servicios</p>
                </div>
            </div>
        </div>
    @endsection
