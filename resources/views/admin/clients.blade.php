    ...
    <div class="mb-4 sm:mb-6">
        <form method="GET" action="{{ route('admin.clients.index') ?? route('clients.index') ?? '#' }}" class="flex flex-col sm:flex-row gap-3">
            <div class="flex-1 relative" style="max-width: 100%;">
                ...
                <input type="text" name="search" id="search-input" class="block w-full pr-3 py-3.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all dark:text-white dark:bg-gray-700 dark:border-gray-600" placeholder="Buscar por nombre, RUT..." value="{{ request('search') }}">
            </div>
