    ...
    <div class="mb-4 sm:mb-6">
        <form method="GET" action="{{ route('admin.clients.index') ?? route('clients.index') ?? '#' }}" class="flex flex-col sm:flex-row gap-3">
            <div class="flex-1 relative" style="max-width: 100%;">
                ...
                <input type="text" name="search" id="search-input" class="block w-full pr-3 py-3.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all" style="border: 1px solid #e5e7eb !important; color: #111827; background: white; padding-left: 40px !important;" placeholder="Buscar por nombre, RUT..." value="{{ request('search') }}">
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50" style="background: #f9fafb;">
                    <tr>
                        ...
                        <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium uppercase tracking-wider" class="text-gray-600 dark:text-gray-300">CONTACTO</th>
