    ...
    <div class="mb-4 sm:mb-6">
        <form method="GET" action="{{ route('admin.clients.index') ?? route('clients.index') ?? '#' }}" class="flex flex-col sm:flex-row gap-3">
            <div class="flex-1 relative" style="max-width: 100%;">
                ...
                <input type="text" name="search" id="search-input" class="block w-full pr-3 py-3.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all" style="border: 1px solid #e5e7eb !important; color: #111827; background: white; padding-left: 40px !important;" placeholder="Buscar por nombre, RUT..." value="{{ request('search') }}">
            </div>
                                ...
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <a href="{{ route('admin.clients.edit', $client) ?? route('clients.edit', $client) ?? '#' }}" class="text-green-600 hover:text-green-900" title="Editar">
                                        <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l2.257-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21h-4.5A2.25 2.25 0 0 1 9 18.75V14a3 3 0 0 1 3-3h2.25Z" />
                                        </svg>
                                    </a>
