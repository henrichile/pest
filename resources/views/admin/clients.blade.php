    ...
    <div class="mb-4 sm:mb-6">
        ...
        <div class="hidden md:flex md:items-center md:justify-between">
            ...
            <div class="mt-3 sm:mt-4 md:mt-0 md:ml-4">
                <a href="{{ route('admin.clients.create') ?? '#' }}" class="inline-flex items-center justify-center w-full sm:w-auto px-3 sm:px-4 py-2 border border-transparent rounded-lg shadow-sm text-xs sm:text-sm font-medium dark:text-white transition-colors">
