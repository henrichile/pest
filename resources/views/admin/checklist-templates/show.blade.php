...
@section('title', 'Ver Template de etapas - Pest Controller SAT')
    ...
    <div class="max-w-4xl mx-auto space-y-6">
                        ...
                        ($item->type === 'number' ? 'bg-green-100 text-green-800' :
                            ...
                            <div class="mt-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                @elseif($item->type === 'select')
                                    <select disabled
                                        class="w-full border border-gray-300 rounded px-3 py-2 bg-white opacity-75 dark:text-white dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex space-x-4">
                <form action="{{ route('admin.checklist-templates.duplicate', $checklistTemplate) }}" method="POST"
                    class="inline">
                    @csrf
                    <button type="submit"
                ...
                <form action="{{ route('admin.checklist-templates.destroy', $checklistTemplate) }}" method="POST"
                    class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
