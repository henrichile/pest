                ...
                <form action="{{ route('admin.checklist-templates.store') }}" method="POST" class="p-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        <div>
                            ...
                            <input type="text" name="name" x-model="template.name" required
                        ...
                        <div>
                            ...
                            <select name="service_type_id" x-model="template.serviceTypeId" required
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="description" x-model="template.description" rows="3"
                            ...
                            <template x-for="(stage, stageIndex) in template.stages" :key="stageIndex">
                                <div class="border border-gray-300 rounded-lg p-6 bg-gray-50">
                                    ...
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <button type="button" @click="removeStage(stageIndex)"
                                            x-show="template.stages.length > 1" class="text-red-600 hover:text-red-900">
                                    ...
                                    <input type="hidden" :name="`stages[${stageIndex}][description]`"
                                        x-bind:value="stage.description">
                                    <input type="hidden" :name="`stages[${stageIndex}][is_required]`"
                                        x-bind:value="stage.isRequired ? '1' : '0'">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                                        <div>
                                            ...
                                            <input type="text" x-model="stage.name" required
                                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                                        </div>

                                        <div>
                                            <label class="flex items-center">
                                                <input type="checkbox" x-model="stage.isRequired"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea x-model="stage.description" rows="2"
                                    ...
                                    <div class="border-t border-gray-300 pt-4">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <button type="button" @click="addItem(stageIndex)"
                                        ...
                                        <div class="space-y-4">
                                            <template x-for="(item, itemIndex) in stage.items" :key="itemIndex">
                                                <div class="border border-gray-200 rounded-lg p-4 bg-white">
                                                    ...
                                                    <input type="hidden"
                                                        :name="`stages[${stageIndex}][items][${itemIndex}][title]`"
                                                        x-bind:value="item.title">
                                                    <input type="hidden"
                                                        :name="`stages[${stageIndex}][items][${itemIndex}][description]`"
                                                        x-bind:value="item.description">
                                                    <input type="hidden"
                                                        :name="`stages[${stageIndex}][items][${itemIndex}][type]`"
                                                        x-bind:value="item.type">
                                                    <input type="hidden"
                                                        :name="`stages[${stageIndex}][items][${itemIndex}][options]`"
                                                        x-bind:value="item.options">
                                                    <input type="hidden"
                                                        :name="`stages[${stageIndex}][items][${itemIndex}][is_required]`"
                                                        x-bind:value="item.isRequired ? '1' : '0'">

                                                    <div class="flex items-center justify-between mb-3">
                                                        <span class="text-sm font-medium text-gray-600">
                                                            Punto <span x-text="itemIndex + 1"></span>
                                                        </span>
                                                        <button type="button" @click="removeItem(stageIndex, itemIndex)"
                                                    ...
                                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select x-model="item.type" required
                                                                class="w-full border border-gray-300 rounded px-2 py-1 text-sm focus:ring-green-500 focus:border-green-500">
                                                    ...
                                                    <div x-show="item.type === 'select'" class="mt-3">
                                                        ...
                                                        <input type="text" x-model="item.options"
                                                    ...
                                                    <div class="mt-3">
                                                        <label class="flex items-center">
                                                            <input type="checkbox" x-model="item.isRequired"
                                                                class="rounded border-gray-300 text-green-600 focus:ring-green-500">
                                                            <span class="ml-2 text-xs text-gray-700">Campo
                                                                obligatorio</span>
                                                        </label>
                                                    </div>
                                                </div>
