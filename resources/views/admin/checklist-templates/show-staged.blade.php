                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            ...
                            <div class="mt-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                @switch($item->type)
                                    @case('text')
                                        <input type="text" disabled placeholder="Campo de texto..." class="placeholder:text-gray-400 dark:placeholder:text-gray-500 w-full px-2 py-1 text-sm border border-gray-300 rounded bg-white dark:text-white dark:bg-gray-700 dark:border-gray-600">
                                        @break
                                    @case('number')
                                        <input type="number" disabled placeholder="0" class="placeholder:text-gray-400 dark:placeholder:text-gray-500 w-full px-2 py-1 text-sm border border-gray-300 rounded bg-white dark:text-white dark:bg-gray-700 dark:border-gray-600">
                                        @break
                                    @case('select')
                                        <select disabled class="w-full px-2 py-1 text-sm border border-gray-300 rounded bg-white dark:text-white dark:bg-gray-700 dark:border-gray-600">
