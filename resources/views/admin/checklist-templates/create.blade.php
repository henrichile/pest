...
@section('page-title', 'Crear Template de etapas')

@section('content')
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('admin.checklist-templates.store') }}" method="POST" x-data="checklistForm()"
            class="space-y-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                            ...
                            placeholder="Ej: Etapas Desratización Estándar">
                        @error('name')
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">Items de las etapas</h2>
                ...
                <div id="items-container">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 mb-4 relative">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div x-show="item.type === 'select'" class="md:col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Opciones (separadas por
                                        comas)</label>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" :name="'items[' + index + '][is_required]'"
                                        x-model="item.is_required" value="1"
                    ...
                    <div x-show="items.length === 0" class="text-center py-8 text-gray-500">
                        ...
                        <p>No hay items en las etapas. Agrega al menos uno para continuar.</p>
                    </div>
                </div>
            </div>
