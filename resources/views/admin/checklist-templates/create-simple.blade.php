                ...
                <form action="{{ route('admin.checklist-templates.store') }}" method="POST" class="p-6">
                        ...
                        <div class="border border-gray-300 rounded-lg p-6 bg-gray-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="hidden" name="stages[0][items][0][options]"
                                        value="Excelente,Bueno,Regular,Malo">
                                    <input type="hidden" name="stages[0][items][0][is_required]" value="1">
                                    <select
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2 dark:text-white dark:bg-gray-700 dark:border-gray-600"
                                        disabled>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="border border-gray-300 rounded-lg p-6 bg-gray-50">
                            ...
                            <input type="hidden" name="stages[1][description]"
                                value="Proceso de aplicación del tratamiento">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text"
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2 dark:text-white dark:bg-gray-700 dark:border-gray-600"
                                        disabled placeholder="Nombre del producto">
                                </div>
