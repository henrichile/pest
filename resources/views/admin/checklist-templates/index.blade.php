...
@section('title', 'Templates de Servicio - Pest Controller SAT')
@section('page-title', 'Gestión de Templates de Servicio')
    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div class="bg-green-50 border border-green-200 rounded-lg p-4 flex-1 mr-4">
                <h3 class="text-lg font-semibold text-green-800">Templates de Servicio</h3>
                <p class="text-green-600 mt-1">Gestiona los templates de etapas para cada tipo de servicio.</p>
            </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                            <div class="flex space-x-2">
                                ...
                                <form action="{{ route('admin.checklist-templates.duplicate', $template) }}" method="POST"
                                    class="inline">
                                    @csrf
            ...
            @empty
                <div class="col-span-full">
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2">No hay templates de etapas</h3>
                        <p class="text-gray-500 mb-4">Comienza creando tu primer template de etapas.</p>
                        <a href="{{ route('admin.checklist-templates.create') }}"
                            class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-purple-600">
                            {{ $templates->sum(function ($t) {
                return $t->items->count(); }) }}</div>
                        <div class="text-sm text-gray-600">Total Items</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-orange-600">{{ $templates->groupBy('service_type_id')->count() }}
                        </div>
